...
Note-kit helps organize your notes and keeps track of information while working with AI on larger projects. Based around a tight user response loop, the kit helps you focus on what's important, keeping details in place without re-treading the same ground. It installs into an Obsidian vault and pairs with Claude Code, and everything it touches is plain markdown in folders you own, portable, and useful in any other LLM memory ecosystem.
